...
add_symbol('RIGHT', 'PROCEDURE', None, value=None, parameters=["num"])
add_symbol('RT', 'PROCEDURE', None, value=None, parameters=["num"])
add_symbol('LEFT', 'PROCEDURE', None, value=None, parameters=["num"])
add_symbol('LT', 'PROCEDURE', None, value=None, parameters=["num"])
add_symbol('PENUP', 'PROCEDURE', None, value=None, parameters=["num"])
add_symbol('PU', 'PROCEDURE', None, value=None, parameters=["num"])
add_symbol('PENDOWN', 'PROCEDURE', None, value=None, parameters=["num"])
add_symbol('PD', 'PROCEDURE', None, value=None, parameters=["num"])
add_symbol('WIPECLEAN', 'PROCEDURE', None, value=None, parameters=["num"])
add_symbol('WC', 'PROCEDURE', None, value=None, parameters=["num"])
add_symbol('CLEARSCREEN', 'PROCEDURE', None, value=None, parameters=["num"])
add_symbol('CS', 'PROCEDURE', None, value=None, parameters=["num"])
add_symbol('HOME', 'PROCEDURE', None, value=None, parameters=["num"])
add_symbol('SETXY', 'PROCEDURE', None, value=None, parameters=["num"])
add_symbol('XCOR', 'PROCEDURE', None, value=None, parameters=["num"])
add_symbol('YCOR', 'PROCEDURE', None, value=None, parameters=["num"])
add_symbol('HEADING', 'PROCEDURE', None, value=None, parameters=["num"])
add_symbol('RANDOM', 'PROCEDURE', None, value=None, parameters=["num"])
add_symbol('PRINT', 'PROCEDURE', None, value=None, parameters=["num"])
add_symbol('TYPEIN', 'PROCEDURE', None, value=None, parameters=["num"])